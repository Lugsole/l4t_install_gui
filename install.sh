...
sudo apt install -y python3-gi python3-gi-cairo gir1.2-gtk-3.0 python3-pip ninja-build libglib2.0-dev
echo "installing l4t_install_glibgui pip dependencies 1"
pip3 install pyyaml
